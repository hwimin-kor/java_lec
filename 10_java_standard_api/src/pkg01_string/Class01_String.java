...
public class Class01_String {
  ...
  public static void method7() {
    ...
    // indOf     : 전달한 문자열이 발견된 첫 번째 인덱스를 반환, 없으면 -1을 반환
    // lastIndOf : 전달한 문자열이 발견된 마지막  인덱스를 반환, 없으면 -1을 반환
  ...
  public static void method8() {
    ...
    // substring(int beginInd)               : beginInd 부터 끝까지 반환
    // substring(int beginInd, int endInd) : beginInd 부터 endInd 이전까지 반환
    
    String str = "hello world";
    
    int spaceInd = str.indexOf(" ");
    
    System.out.println(str.substring(0, spaceInd));
    System.out.println(str.substring(spaceInd + 1));
  ...
  public static void practice01() {
    ...
    // /list.do 추출하기
    String url = "http://localhost:8080/project/list.do";
    String conttPath = "/project";
    
    
    int word=url.lastIndexOf("l");
    
    System.out.println(url.substring(word));
